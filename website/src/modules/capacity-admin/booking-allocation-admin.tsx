...
import { BookingAllocationExcelReader } from '@/modules/capacity-admin/booking-allocation-excel-reader';
...
export const BookingAllocationAdmin: React.FC = () => {
  ...
  return (
    <GridContainer>
      <GridItem>
        <BookingAllocationExcelReader onDataParsed={onDataParsed} />
        <Spacer size="07" />
      </GridItem>
